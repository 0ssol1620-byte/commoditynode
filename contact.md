...
<div class="contact-grid" data-animate>
  ...
  <div class="post-content">
    ...
    <ul>
      <li><strong>News tips</strong> — Commodity price moves we should cover</li>
      <li><strong>Data corrections</strong> — Spotted a mistake in our analysis?</li>
      <li><strong>Partnerships</strong> — Research collaborations, data partnerships</li>
      <li><strong>Feedback</strong> — What we're getting right (and wrong)</li>
    </ul>
    ...
    <p>Stay updated with our latest commodity analysis:</p>
    <ul>
      <li><strong>Threads:</strong> <a href="https://www.threads.com/@commoditynode" target="_blank" rel="noopener">@commoditynode</a> — Daily commodity signals and market insights</li>
      <li><strong>RSS Feed:</strong> <a href="/feed.xml">commoditynode.com/feed.xml</a> — Subscribe in any feed reader</li>
