...
window.COMMODITY_DATA = {
  ...
  levels: [
    { nodes: [
      ...
      { id: "dal", label: "Delta Air Lines (DAL)", type: "negative", impact: -7.8, correlation: -0.76, marketCap: "30B", sector: "Airlines" },
      { id: "ual", label: "United Airlines (UAL)", type: "negative", impact: -8.2, correlation: -0.79, marketCap: "22B", sector: "Airlines" },
      { id: "aal", label: "American Airlines (AAL)", type: "negative", impact: -11.5, correlation: -0.83, marketCap: "9.5B", sector: "Airlines" },
      { id: "luv", label: "Southwest Airlines (LUV)", type: "negative", impact: -6.5, correlation: -0.70, marketCap: "18B", sector: "Airlines" }
    ]},
    { nodes: [
      { id: "ryaay", label: "Ryanair (RYAAY)", type: "negative", impact: -7.0, correlation: -0.72, marketCap: "25B", sector: "Airlines", parentId: "jets" },
      { id: "bkng", label: "Booking Holdings (BKNG)", type: "negative", impact: -4.2, correlation: -0.48, marketCap: "135B", sector: "Travel/OTA", parentId: "dal" },
      { id: "expe", label: "Expedia Group (EXPE)", type: "negative", impact: -5.0, correlation: -0.52, marketCap: "19B", sector: "Travel/OTA", parentId: "ual" },
      { id: "mar", label: "Marriott Intl (MAR)", type: "negative", impact: -3.0, correlation: -0.38, marketCap: "72B", sector: "Hotels", parentId: "dal" },
      { id: "hlt", label: "Hilton Worldwide (HLT)", type: "negative", impact: -2.8, correlation: -0.35, marketCap: "56B", sector: "Hotels", parentId: "ual" }
    ]},
    { nodes: [
      { id: "ccl", label: "Carnival Corp (CCL)", type: "negative", impact: -6.5, correlation: -0.61, marketCap: "24B", sector: "Cruise Lines", parentId: "bkng" },
      { id: "rcl", label: "Royal Caribbean (RCL)", type: "negative", impact: -5.8, correlation: -0.57, marketCap: "42B", sector: "Cruise Lines", parentId: "expe" },
      { id: "ba", label: "Boeing Co (BA)", type: "negative", impact: -3.5, correlation: -0.42, marketCap: "130B", sector: "Aircraft Mfg", parentId: "aal" },
      { id: "air", label: "Airbus SE (AIR)", type: "negative", impact: -3.0, correlation: -0.38, marketCap: "115B", sector: "Aircraft Mfg", parentId: "ryaay" }
    ]},
    { nodes: [
      { id: "vlo", label: "Valero Energy (VLO)", type: "positive", impact: 6.5, correlation: 0.78, marketCap: "48B", sector: "Refining", parentId: "jets" },
      { id: "psx", label: "Phillips 66 (PSX)", type: "positive", impact: 5.8, correlation: 0.72, marketCap: "52B", sector: "Refining", parentId: "jets" },
      { id: "tsa", label: "TSA Throughput", type: "negative", impact: -3.0, sector: "Macro", parentId: "bkng" },
      { id: "trip", label: "TripAdvisor (TRIP)", type: "negative", impact: -3.8, correlation: -0.40, marketCap: "3.5B", sector: "Travel/OTA", parentId: "expe" }
    ]},
    { nodes: [
      { id: "tourism", label: "Global Tourism GDP", type: "negative", impact: -2.0, sector: "Macro", parentId: "ccl" },
      { id: "business_travel", label: "Business Travel Index", type: "negative", impact: -2.5, sector: "Macro", parentId: "mar" },
      { id: "fuel_hedge", label: "Airline Hedge Ratios", type: "positive", impact: 3.0, sector: "Macro", parentId: "luv" },
      { id: "carbon_offset", label: "Carbon Credit Costs", type: "negative", impact: -1.5, sector: "Macro", parentId: "ba" }
    ]}
  ]
};
</script>
