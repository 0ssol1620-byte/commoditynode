---
layout: post
title: "Gallium: China's Semiconductor Chokepoint — The Metal You Can't Make Chips Without"
date: 2026-03-24
categories: [Critical Minerals, Analysis]
tags: [gallium, semiconductor, china, defense, 5g]
description: "China controls 98% of gallium production and weaponized exports in 2023. GaN chips power 5G and defense — and the West has no Plan B. The most asymmetric supply risk in semiconductors."
reading_time: 7
...
1. **GaN pure-plays (NVTS, WOLF)** offer the most direct equity exposure to gallium's critical role. These are volatile small/mid-caps — size positions accordingly. NVTS at current levels (~$8-9) trades at 12x forward revenue with 80%+ growth. The bear case is execution risk; the bull case is that GaN becomes as essential as silicon.

2. **Defense primes (RTX, NOC, LHX)** provide a more conservative way to play the GaN demand thesis with built-in downside protection from government contract backlogs. RTX's 3.2% yield pays you to wait.
...
4. **Watch the China policy calendar**: Beijing has renewed gallium export licenses on a case-by-case basis, allowing some exports to resume. Any tightening — especially in response to US semiconductor escalation — could trigger a price spike that cascades through the GaN supply chain within weeks.
