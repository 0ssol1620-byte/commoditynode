...
1. Any follow-through on Black Sea export constraints, corridor access, or shipping friction
2. Importer behavior from major wheat-dependent countries, especially signs of earlier or more defensive buying
3. USDA and other crop-balance updates to see whether non-Black Sea supply can offset the concern
4. Relative moves in corn and other substitute grains, because cross-grain substitution can either cap or amplify the wheat move
