...
sensitivity: high
confidence: medium
canonical_url: https://commoditynode.com/coffee-premium-unwind-extends/
description: "Coffee fell another 8.15% to 272.3 cents/lb, and the refreshed CommodityNode forecast stack still points lower as supply-relief headlines and a firmer dollar keep pressuring the premium."
---
...
Arabica fell another 8.15% to 272.3 cents/lb in the latest CommodityNode refresh. The updated model stack remains bearish after the drop: the 30-day consensus sits near 261.48, the 90-day consensus near 259.75, Chronos-2 ends around 252.32, and TimesFM still finishes below spot near 267.17. That matters because even after a violent selloff, both models still refuse to argue for a meaningful recovery back above current levels.
...
The important signal is not just that prices fell. It is that the consensus path remains below spot after the fall. That keeps the balance of risk tilted toward more downside unless a new weather or crop shock interrupts the unwind.
...
- bearish softs positioning keeps control of the tape
...
1. Whether coffee quickly breaks into the low-260s, where the consensus path is already pointing
2. Whether dollar strength keeps reinforcing the move lower
3. Whether any Brazil or producer-country weather headlines are strong enough to reverse sentiment
4. Whether TimesFM starts converging downward toward the more bearish Chronos-2 path
...
**Related hub:** [Coffee Impact Map](/commodities/coffee/)
